...
public class CashCookoutWLAEngineManagerTest
{
	...
	{
		logger = Logger.getLogger(CashCookoutWLAEngineManagerTest.class);
		gameParams = XMLUtil.parseResource("paymodel/CashCookoutWLAIW/GameParams.xml").getDocumentElement();
		previousOutcome = XMLUtil.parseResource("paymodel/CashCookoutWLAIW/InitOutcome.xml").getDocumentElement();
